...
//            onMenu_media_library();
        ...
        if (s.equals(menu.getMenu_graph_analyzerSettings()))
        	onMenu_graphs_analyzerSettings();
        ...
        if (s.equals(menu.getMenu_graph_bfilter()))
            onMenu_graph_bfilter();

        if (s.equals(menu.getMenu_graph_geffect()))
            onMenu_graph_geffect();
    ...
    public abstract void onMenu_graphs_analyzerSettings();
